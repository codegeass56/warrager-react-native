...
- **Dependency management**: I navigated library conflicts and learned to integrate popular third-party packages, ensuring robustness and a consistent user experience.
- **Clean code and architecture**: This project was an initial foray into building a scalable application. This helped me understand the importance of clear folder structures and maintainable code.
- **Using TypeScript with React**: I had to learn to establish clear and consistent typing across components throughout the project.
- **Importance of reusability**: This application served as a launchpad to develop applications where I have been able to reuse form components from this project. This has taught me the importance and scalability of reusable components.
